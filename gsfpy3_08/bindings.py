...
def gsfSeek(handle: c_int, option: SeekOption) -> int:
    """
    :param handle: c_int
    :param option: gsfpy3_08.enums.SeekOption
    :return: 0 if successful, otherwise -1
    """
...
def gsfIndexTime(
    ...
    """
    :param handle: c_int
    :param record_type: gsfpy3_08.enums.RecordType
...
def gsfGetSwathBathyBeamWidths(p_data, p_fore_aft, p_athwartship) -> int:
    """
    :param p_data: POINTER(gsfpy3_08.gsfRecords.c_gsfRecords)
...
def gsfGetSwathBathyArrayMinMax(
    ...
    """
    :param p_ping: POINTER(gsfpy3_08.gsfSwathBathyPing.c_gsfSwathBathyPing)
...
def gsfIsNewSurveyLine(
    ...
    """
    :param handle: c_int
    :param p_rec: POINTER(gsfpy3_08.gsfRecords.c_gsfRecords)
...
def gsfInitializeMBParams(p_mbparams) -> int:
    """
    :param p_mbparams: POINTER(gsfpy3_08.gsfMBParams.c_gsfMBParams)
...
def gsfCopyRecords(p_target, p_source):
    """
    :param p_target: POINTER(gsfpy3_08.gsfRecords.c_gsfRecords). Note that this parameter
                     must be passed as a pointer() rather than a byref().
    :param p_source: POINTER(gsfpy3_08.gsfRecords.c_gsfRecords). Note that this parameter
                     must be passed as a pointer() rather than a byref().
    :return: 0 if successful, otherwise -1. Note that, in the event of a successful
...
def gsfLoadScaleFactor(
    ...
    """
    :param p_sf: POINTER(gsfpy3_08.gsfRecords.c_gsfScaleFactors)
...
def gsfSetDefaultScaleFactor(p_mb_ping) -> int:
    """
    :param p_mb_ping: POINTER(gsfpy3_08.gsfSwathBathyPing.c_gsfSwathBathyPing)
...
def gsfGetPositionDestination(gp, offsets, heading: c_double, dist_step: c_double):
    """
    :param gp: gsfpy3_08.GSF_POSTIION.c_GSF_POSITION
    :param offsets: gsfpy3_08.GSF_POSTIION_OFFSETS.c_GSF_POSITION_OFFSETS
    :param heading: c_double
    :param dist_step: c_double

    :return: POINTER(gsfpy3_08.GSF_POSITION.GSF_POSITION) - the destination position.
    """
...
def gsfGetPositionOffsets(gp_from, gp_to, heading: c_double, dist_step: c_double):
    """
    :param gp_from: gsfpy3_08.GSF_POSTIION.c_GSF_POSITION
    :param gp_to: gsfpy3_08.GSF_POSTIION.c_GSF_POSITION
    :param heading: c_double
    :param dist_step: c_double

    :return: POINTER(gsfpy3_08.c_GSF_POSITION_OFFSETS.c_GSF_POSITION_OFFSETS) -
